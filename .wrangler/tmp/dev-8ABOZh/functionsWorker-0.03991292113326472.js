...
// .wrangler/tmp/bundle-GPf61b/checked-fetch.js
...
// .wrangler/tmp/bundle-GPf61b/middleware-loader.entry.ts
var import_checked_fetch15 = __toESM(require_checked_fetch());

// wrangler-modules-watch:wrangler:modules-watch
var import_checked_fetch = __toESM(require_checked_fetch());

// .wrangler/tmp/bundle-GPf61b/middleware-insertion-facade.js
var import_checked_fetch13 = __toESM(require_checked_fetch());

// .wrangler/tmp/pages-Sd68uN/functionsWorker-0.03991292113326472.mjs
...
var require_checked_fetch2 = __commonJS2({
  "../.wrangler/tmp/bundle-G3dgdP/checked-fetch.js"() {
    var urls = /* @__PURE__ */ new Set();
    function checkURL(request, init) {
      const url = request instanceof URL ? request : new URL(
        (typeof request === "string" ? new Request(request, init) : request).url
...
//# sourceMappingURL=functionsWorker-0.03991292113326472.js.map
